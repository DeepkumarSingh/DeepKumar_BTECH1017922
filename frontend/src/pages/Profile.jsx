          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 border border-gray-200 rounded-lg bg-white text-gray-700"
                required
              />
              <p className="text-xs text-gray-400 mt-2">If you change your email, we'll update it immediately (you may need to re-login in some setups).</p>
            </div>
